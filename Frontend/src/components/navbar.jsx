                ...
                <div className="navbar">
                    ...
                    <div className="navbar-end space-x-3">
                        ...
                        <div className="hidden md:block">
                            <label className="input px-3 py-2 border rounded-md w-60 outline-none">
                        ...
                        <div>
                            <a onClick={loginClick} className="bg-black text-white px-3 py-2 rounded-md hover:bg-slate-800 duration-300 cursor-pointer">Login</a>
                            <Login/>
                        </div>
                    </div>
                </div>
